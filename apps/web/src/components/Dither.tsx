...
export default function Dither({
  ...
  waveFrequency = 3,
  waveAmplitude = 0.3,
  waveColor = [0.35, 0.0, 0.5], // purplish tone you liked
  colorNum = 4,
  pixelSize = 2,
  ...
  const backgroundColor =
    theme === "light"
      ...
      : "#100624"; // dark bluish-purple for dark mode

  // optional: gradient background (soft lavender in light mode)
  const backgroundGradient =
    theme === "light"
      ? "linear-gradient(135deg, #ffffff 0%, #eae6ff 100%)"
      : "linear-gradient(135deg, #0a0216 0%, #1a0b3c 100%)";
  ...
  return (
    <Canvas
      ...
      style={{
        background: backgroundGradient, // 🩵 soft theme gradient
      }}
    >
      {/* Actual 3D scene background (helps blend properly) */}
